...
file = open("E:\\ChexPad\\PADCHEST_chest_x_ray_images_labels_160K_01.02.19.csv")
imageDirSrc= 'E:\\ChexPad\\Images\\'
imageDirDest= '\data\public_data\ChexPad\\Images\\'
...
def main():
    ...
    with open(imageDirSrc+'ChexNet.csv', 'w') as f:
