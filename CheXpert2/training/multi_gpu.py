...
if __name__ == "__main__":
    ...
    results = main(config, img_dir, model, experiment, optimizer, torch.nn.BCEWithLogitsLoss(pos_weight=torch.ones((num_classes,),device=device)*config["pos_weight"]), device, prob,
